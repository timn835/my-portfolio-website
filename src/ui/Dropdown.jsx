...
function Dropdown({ id, openId, setOpenId, children }) {
  ...
  const darkTriggerClasses = `dropdown-trigger transition delay-150 ease-in-out hover:text-zinc-400${
    openId === id ? " text-zinc-400" : ""
  }`;
  const lightTriggerClasses = `dropdown-trigger transition delay-150 ease-in-out hover:text-sky-600${
